...
<section class="ttm-row zero-padding-section ttm-bgcolor-skincolor clearfix" style="margin-bottom: 5px;">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4">
                <!--  featured-icon-box -->
                <div class="featured-icon-box left-icon style7" style="margin-top: 10px;">
                    <div class="featured-icon">
                        <!--  featured-icon -->
                        <div class="ttm-icon ttm-icon_element-color-white ttm-icon_element-size-lg">
                            <i class="flaticon flaticon-hen"></i><!--  ttm-icon -->
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="ttm_single_image-wrapper mr_95 res-991-mr-0 position-relative z-1 res-991-center">
                        <img class="img-fluid" src="images/Imagenes/logo.png" title="single-img-one" alt="single-img-one">
                    ...
                    <div class="spacing-1 ttm-bgcolor-white bordertop-12px-solid skincolor-border">
                        ...
                        <div class="section-title clearfix">
                            <div class="title-header">
                                <h5>POULTRY INDUSTRIAL PERU</h5>
                                <h2 class="title">Equipamiento y servicios para la industria de producción animal</h2>
                            </div>
                            <div class="heading-seperator">
                                <span></span>
                            </div>
                        </div><!-- section title end -->
                        <p>Representamos y distribuimos equipos y soluciones de las principales marcas de la industria a nivel mundial, orientandonos principalmente a la producción de aves y cerdos con el propósito de incrementar la eficiencia y capacidad de nuestros clientes para mejorar sus procesos productivos.</p>
                        <p>Además, ofrecemos un amplio portafolio de servicios desde obras civiles hasta instalaciones y mantenimientos.</p>
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="featured-icon-box style1 left-icon icon-align-top">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-title">
                                            <!--  featured-title -->
                                            <h5>Mejora la conversión alimenticia</h5>
                                        </div>
                                    </div>
                                </div><!--  featured-icon-box END -->
                            </div>
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="featured-icon-box style1 left-icon icon-align-top">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-title">
                                            <!--  featured-title -->
                                            <h5>Mayor eficiancia en la mano de obra</h5>
                                        </div>
                                    </div>
                                </div><!--  featured-icon-box END -->
                            </div>
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="featured-icon-box style1 left-icon icon-align-top">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-title">
                                            <!--  featured-title -->
                                            <h5>Rápido retorno sobre la inversión</h5>
                                        </div>
                                    </div>
                                </div><!--  featured-icon-box END -->
                            </div>
                                ...
                                <div class="featured-icon-box without-icon style1 text-left pt-15">
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc">
                                            <!--  featured-desc -->
                                            <p>Llámanos para cualquier consulta</p>
                                        </div>
                                        <div class="featured-title">
                                            <!--  featured-title -->
                                            <h5>+51 994239667</h5>
...
<section class="ttm-row zero-padding-section mt_85 res-991-mt-0 clearfix">
    <div class="container">
        <div class="row ttm-bgcolor-skincolor featured-icon-box-style2-row">
            <!-- row -->
            <div class="col-lg-4">
                <!--  featured-icon-box -->
            ...
            <div class="col-lg-4">
                ...
                <div class="featured-icon-box left-icon style2 ttm-bgcolor-white res-991-mt-20">
                    ...
                    <div class="featured-content">
                        ...
                        <div class="featured-title">
                            <!--  featured-title -->
                            <h5>1000+ galpones y proyectos</h5>
                        </div>
                        <div class="featured-desc">
                            <!--  featured-desc -->
                            <p>vendidos</p>
            ...
            <div class="col-lg-8 offset-lg-2">
                <div class="text-center">
                    ...
                    <div class="section-title row-title clearfix">
                        <div class="title-header">
                            <h5 class="mb-10">NOSOTROS</h5>
                            <h2 class="title fw-700 mb-5"> POULTRY INDUSTRIAL PERU</h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="res-991-mb-30">
                    ...
                    <div class="section-title clearfix">
                        <div class="title-header">
                            <h5> ¿Con qué marcas trabajamos?</h5>
                            <h2 class="title">Marcas más importantes
                                de la industria.</h2>
                        </div>
                        <div class="heading-seperator">
                            <span></span>
                    ...
                    <p>Con nuestras representadas cubrimos
                        todas las necesidades que la industria
                        requiere en las categorías de:
                    </p>
                    <div class="mt-25">
