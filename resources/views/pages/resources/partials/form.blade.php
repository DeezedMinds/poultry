  ...
  <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
    ...
    <div class="grid grid-cols-1 mt-5 mx-7">
      ...
      <div class='flex items-center justify-center w-full'>
        <label for="pdf" class='flex flex-col border-4 border-dashed w-full h-32 hover:bg-gray-100 hover:border-green-300 group'>
          <div class='flex flex-col items-center justify-center pt-7'>
            ...
            <p class='lowercase text-sm text-gray-400 group-hover:text-green-600 pt-1 tracking-wider'>{{__('actions.upload_pdf') . __('resources.of_resource')}}</p>
          </div>
          <input type='file' class="hidden" name="pdf" id="pdf" accept="application/pdf" />
        </label>
      </div>
    </div>
