                    ...
                    <div class="featured-icon-box top-icon style1 text-center ttm-bgcolor-white">
                        <div class="featured-icon">
                            ...
                            <div class="ttm-icon ttm-icon_element-color-skincolor ttm-icon_element-size-lg">
                                <i class="flaticon flaticon-pig"></i><!--  ttm-icon -->
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-title text-center clearfix">
                        <div class="title-header">
                            <h5>INSTALACIÓN</h5>
                            <h2 class="title">Instalación de equipos para cerdos multimarca</h2>
                        </div>
                        <div class="heading-seperator">
                            <span></span>
                        </div>
                    ...
                    <div class="featured-icon-box top-icon style2 text-center ttm-bgcolor-darkgrey">
                        ...
                        <div class="featured-content">
                            ...
                            <div class="featured-desc">
                                <!--  featured-desc -->
                                <p>Damos mantenimientos preventivos y correctivos de todo tipo de equipamiento para crianza de cerdos</p>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="featured-icon-box top-icon style2 text-center ttm-bgcolor-darkgrey">
                        ...
                        <div class="featured-content">
                            ...
                            <div class="featured-desc">
                                <!--  featured-desc -->
                                <p>Capacitamos en la utilización de sistemas porcícolas y los equipos derivados</p>
                                <br>
                            </div>
                        </div>
                    </div><!--  featured-icon-box END -->
